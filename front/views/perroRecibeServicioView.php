            ...
            <div class="bg-white p-4 rounded shadow-lg w-1/2">
                ...
                <form id="crearNuevoServicio" class="space-y-4" method="POST" action="http://localhost/gromer/front/index.php?controller=perroRecibeServicioUso&action=crearServicioRealizadoAPerro">
                    <div>
                        ...
                        <input type="text" id="dni" name="perro_id" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                    </div>
                    <div>
                        <label for="nombre" class="block text-sm font-medium text-gray-700">ID del servicio:</label>
                        <input type="text" id="nombre" name="servicio_id" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                    </div>
                    <div>
                        <label for="fecha_nto" class="block text-sm font-medium text-gray-700">Fecha de la realización:</label>
                        <input type="text" id="fecha_nto" name="fecha" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                    </div>
                    <div>
                        <label for="raza" class="block text-sm font-medium text-gray-700">ID del empleado que lo realiza:</label>
                        <input type="text" id="raza" name="empleado_id" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                    </div>
                    <div>
                        <label for="peso" class="block text-sm font-medium text-gray-700">Precio final:</label>
                        <input type="text" id="peso" name="precioFinal" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                    </div>
                    <div>
                        <label for="altura" class="block text-sm font-medium text-gray-700">Incidencias:</label>
                        <input type="text" id="altura" name="incidencias" class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2">
                    </div>
